...
class NoteFragment : Fragment(), OnClickItem {
    ...
    private fun setUpListeners() {
        ...
        binding.imgChangeLayout.setOnClickListener{
            sharedPreferences = PreferenceHelper().unit(requireContext())
            sharedPreferences.isGridLayout = !sharedPreferences.isGridLayout
            val layoutManager = if (sharedPreferences.isGridLayout){
