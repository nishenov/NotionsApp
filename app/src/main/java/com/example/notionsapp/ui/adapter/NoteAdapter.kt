...
class NoteAdapter(private val onLongClickItem: OnClickItem, private val onClickItem: OnClickItem) : ListAdapter<NoteModel, NoteAdapter.ViewHolder>(DiffCallback()){
